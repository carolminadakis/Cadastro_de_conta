...
public class Main {
	...
	public static void main(String[] args) {
		...
		Caixa caixa1 = new Caixa("Jana�na", "Caixa");
		Seguranca seguranca1 = new Seguranca("Jos�", "Seguran�a");
		...
		PessoaJuridica pessoaJuridica1 = new PessoaJuridica("Conex�o Ltda", "78.823.834/0001-94");
